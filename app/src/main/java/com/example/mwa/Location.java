...
public class Location {
    ...
    public static Location[] locations = {
            ...
            new Location(-33.81002f, 151.29739f, "Barracks Precinct Entrance", R.drawable.barracks, -1, R.string.barracks_precinct_entrance),
            new Location(-33.81075f, 151.29755f, "Parade Ground", R.drawable.parade_ground, -1, -1),
            new Location(-33.80035f, 151.28392f, "Manly Wharf", -1, R.drawable.marker_ferry, -1),
            new Location(-33.80802f, 151.29091f, "Penguins", -1, R.drawable.marker_penguin, -1),
            new Location(-33.8276f,  151.29586f, "Whales", -1, R.drawable.marker_whale, -1),
            new Location(-33.81478f, 151.28826f, "QStation Retreat", R.drawable.qstation_retreat,-1,  -1),
            new Location(-33.81224f, 151.29744f, "Bandicoot Heaven", R.drawable.north_head_sanctuary_foundation, -1, R.string.north_head_sanctuary_foundation),
            new Location(-33.80822f, 151.28888f, "Jump Rock", R.drawable.jump_rock, -1, -1),
            new Location(-33.81752f, 151.29597f, "Visitor Centre", -1, -1, -1),
    };
}